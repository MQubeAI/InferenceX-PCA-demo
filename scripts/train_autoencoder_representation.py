#!/usr/bin/env python3
"""Run the bounded deterministic-autoencoder representation screening."""
...
def main() -> None:
    ...
    parser.add_argument("--output", default="artifacts/representation-ae-db-dump-2026-07-20.json")
    parser.add_argument("--weights", default="artifacts/representation-ae-db-dump-2026-07-20.pt")
    ...
    print(
        ...
        f"validation MSE {selected['validation_mse_mean']:.6f}"
    )
